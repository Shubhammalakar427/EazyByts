  ...
  <div class="row mt-2">
    ...
    <div class="col-md-5 col-lg-6 mt-4">
         <div class="py-3 mx-5">
          ...
          <div class="py-3 mx-5">
            <a href="login.html"style="text-decoration: none;"><input type="button" class="form-control btn-danger text-white" value="Login"></a>
          </div>
          <div class="">
           <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea, omnis.</P>
          </div>
     </div>
...
<div class="row">
  ...
  <h3 calss="text-primary" id="ss" style="margin-left: 35px; margin-top:30px;"><?php echo $post_title; ?></h3>
...
<section id="" class="footer_wrrper bg-red bg-info text-white">
    ...
    <div class=" row textall">
      <div class="col-lg-3 col-sm-6 textside mt-3">
        <h5 id="home"><a href="#home" style="text-decoration: none;" class="m-4 text-white ">Contant Management</a></h5>
         ...
         <div class="btnfoot">
          <a href="login.html"class="cardbtn m-4 text-white btn btn-success" style="text-decoration: none;">POST NOW</a>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 textside mt-3">
      ...
      <div class="col-lg-3 col-sm-6 textside mt-4">
...
<script>
  function checkdelete(){
    return confirm('Are you sure your record to delete');
  }
</script>
</body>
